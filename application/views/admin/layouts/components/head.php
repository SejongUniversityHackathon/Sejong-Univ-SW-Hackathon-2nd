        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="http://darkgogi.com/ht/index.php/admin/track" class="site_title"><i class="fa fa-university"></i> <span>트랙관리시스템</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bar-chart"></i> 트랙 관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=site_url() . 'index.php/admin/track'?>">트랙 설정</a></li>
                      <li><a href="<?=site_url() . 'index.php/admin/track/addTrackPage'?>">트랙 추가</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-building"></i> 취업 관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">진로 로드맵 설정</a></li>
                      <li><a href="#">트랙 개설 요청 확인</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="<?=site_url()?>index.php/admin/login/logout"><i class="fa fa-sign-out pull-right"></i> 로그아웃</a></li>
                  </ul>
                </li>
